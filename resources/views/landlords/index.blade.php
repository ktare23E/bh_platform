                ...
                <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                        ...
                        <div class="p-4 text-right">
                            <p
                                class="block antialiased  text-sm leading-normal font-normal text-blue-gray-600">
                                Today's Money</p>
                            <h4
                        ...
                        <div class="border-t border-blue-gray-50 p-4">
                            <p
                                class="block antialiased  text-base leading-relaxed font-normal text-blue-gray-600">
                ...
                <div class="mb-4 grid grid-cols-1 gap-6 xl:grid-cols-3">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <h6
                                    class="block antialiased tracking-normal  text-base font-semibold leading-relaxed text-blue-gray-900 mb-1">
                                    Projects</h6>
                                <p
                                    class="antialiased  text-sm leading-normal flex items-center gap-1 font-normal text-blue-gray-600">
                            ...
                            <button aria-expanded="false" aria-haspopup="menu" id=":r5:"
                                class="relative middle none  font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-8 max-w-[32px] h-8 max-h-[32px] rounded-lg text-xs text-blue-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30"
                                type="button">
                            ...
                            <table class="w-full min-w-[640px] table-auto">
                                <thead>
                                    <tr>
                                        <th class="border-b border-blue-gray-50 py-3 px-6 text-left">
                                            <p
                                                class="block antialiased  text-[11px] font-medium uppercase text-blue-gray-400">
                                                companies</p>
                                        </th>
                                        <th class="border-b border-blue-gray-50 py-3 px-6 text-left">
                                            <p
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <p
                                                class="block antialiased  text-xs font-medium text-blue-gray-600">
                                                $14,000</p>
                                        </td>
                                        <td class="py-3 px-5 border-b border-blue-gray-50">
                                            <div class="w-10/12">
                                                <p
                                                    class="antialiased  mb-1 block text-xs font-medium text-blue-gray-600">
                                                    60%</p>
                                                <div
                                                    class="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm  text-xs font-medium h-1">
